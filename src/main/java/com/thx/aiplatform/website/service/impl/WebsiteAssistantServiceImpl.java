...
import com.thx.aiplatform.website.service.WebsiteKnowledge;
import com.thx.aiplatform.website.service.WebsiteSettingsService;
import org.springframework.stereotype.Service;
import reactor.core.publisher.Flux;

/**
 * 网站助手业务实现：助手编号固定为 "website"，请求体里没有也不接受助手编号，
 * 浏览器侧因此无法切换到其他助手。系统提示词每次只装配当前问题召回的知识片段，
 * 后台保存后无需重启即可生效，也避免小问题每次都携带整个知识库浪费 token。
 */
@Service
public class WebsiteAssistantServiceImpl implements WebsiteAssistantService {
    ...
    public WebsiteAssistantServiceImpl(
